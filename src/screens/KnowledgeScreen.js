...
const styles = StyleSheet.create({
  ...
  subjectChipActive: { backgroundColor: '#2F2A24' },
  subjectChipText: { fontSize: 14, color: '#6F655D', flexShrink: 0 },
  ...
  questionHeader: { marginBottom: 8, position: 'relative', paddingTop: 30, paddingRight: 90 },
  question: { fontSize: 15, color: '#333', lineHeight: 22, marginBottom: 8, fontWeight: '500' },
  typeBadge: { position: 'absolute', right: 0, top: 0, borderRadius: 10, paddingHorizontal: 8, paddingVertical: 4, minWidth: 64, alignItems: 'center' },
  typeBadgeKnowledge: { backgroundColor: '#F6EEDC' },
  typeBadgeError: { backgroundColor: '#FF6B6B22' },
  typeBadgeText: { fontSize: 11, fontWeight: '600' },
  typeTextKnowledge: { color: '#C49A4B' },
  ...
  summary: { fontSize: 13, color: '#666', lineHeight: 20, backgroundColor: '#F9F1DF', borderRadius: 8, padding: 8, marginBottom: 10 },

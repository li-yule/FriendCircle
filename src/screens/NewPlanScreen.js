...
const styles = StyleSheet.create({
  ...
  sendBtn: { backgroundColor: '#2F9F97', paddingHorizontal: 16, paddingVertical: 7, borderRadius: 20, minWidth: 62, alignItems: 'center' },
  ...
  heroTitle: { fontSize: 14, fontWeight: '700', color: '#2F9F97' },
  heroDesc: { fontSize: 12, color: '#6F655D', lineHeight: 18 },
  fieldCard: {
    backgroundColor: '#FFFDF8',
    borderRadius: 14,
    padding: 14,
  ...
  datePickerText: { color: '#2F9F97', fontWeight: '600', fontSize: 14 },
  ...
  reminderToggleOn: { backgroundColor: '#EAF7F5' },
  reminderToggleText: { fontSize: 12, color: '#777', fontWeight: '600' },
  reminderToggleTextOn: { color: '#2F9F97' },
  reminderInputRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  reminderInput: { flex: 1, fontSize: 14, color: '#2F9F97', fontWeight: '600' },
  ...
  todayTipText: { flex: 1, fontSize: 13, color: '#6F655D', lineHeight: 18 },
});

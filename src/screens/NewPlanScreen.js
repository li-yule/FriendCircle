...
const styles = StyleSheet.create({
  ...
  sendBtn: { backgroundColor: '#C49A4B', paddingHorizontal: 16, paddingVertical: 7, borderRadius: 20, minWidth: 62, alignItems: 'center' },
  ...
  heroTitle: { fontSize: 14, fontWeight: '700', color: '#8A7242' },
  ...
  datePickerText: { color: '#8A7242', fontWeight: '600', fontSize: 14 },
  ...
  reminderToggleOn: { backgroundColor: '#F6EEDC' },
  reminderToggleText: { fontSize: 12, color: '#777', fontWeight: '600' },
  reminderToggleTextOn: { color: '#8A7242' },
  reminderInputRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,

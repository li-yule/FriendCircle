...
const styles = StyleSheet.create({
  ...
  filterBtnActive: { backgroundColor: '#2F9F97' },
  ...
  uploadHint: { fontSize: 11, color: '#2F9F97', fontWeight: '600' },
  ...
  commentName: { fontSize: 12, fontWeight: '600', color: '#2F9F97', marginBottom: 2 },
